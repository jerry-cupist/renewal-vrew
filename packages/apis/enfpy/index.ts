...
import createPersonalityApi, { PersonalityAPis } from './personality'
...
export class EnfpyApiClient {
  ...
  constructor(params: {
    ...
    this.auth = apis.auth
    this.user = apis.user
    this.personality = apis.personality
  }
...
export default new EnfpyApiClient({
  ...
  apis: {
    ...
    personality: createPersonalityApi(apiClient),
  },
})
